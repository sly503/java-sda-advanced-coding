 ...
 * • float weight
 * • boolean isExpress
 * The validator should verify that the sum of the dimensions (x, y, z) does not
 * exceed 300, whether each size is
 * not less than 30, whether the weight does not exceed 30.0 for isExpress =
 * false or 15.0 for isExpress = true. In
